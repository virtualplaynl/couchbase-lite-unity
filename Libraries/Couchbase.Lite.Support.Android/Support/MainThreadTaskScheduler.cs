...
namespace Couchbase.Lite.Support
{
    ...
    internal sealed class MainThreadTaskScheduler : TaskScheduler, IMainThreadTaskScheduler
    {
        ...
        private UnityTaskScheduler schedulerObject {
            get {
                if(scheduler == null) {
                    scheduler = new GameObject("Couchbase Task Scheduler", typeof(UnityTaskScheduler)).GetComponent<UnityTaskScheduler>();
                    scheduler.MainThreadTaskScheduler = this;
                }
                return scheduler;
            }
        }
        ...
        public bool IsMainThread => schedulerObject.OnMainThread;
        ...
        {
            return schedulerObject.GetTasks();
        }
